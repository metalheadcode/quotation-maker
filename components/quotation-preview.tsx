        ...
        <div className="grid grid-cols-[60%_40%] gap-0 mt-6">
          ...
          <div>
            <table className="w-full text-sm" style={{ tableLayout: 'fixed' }}>
              ...
              <tbody>
                <tr>
                  <td className="py-2 border-b border-gray-200">Subtotal (MYR):</td>
                ...
                {data.discount > 0 && (
                  <tr>
                    <td className="py-2 border-b border-gray-200">Discount (MYR):</td>
                    <td className="py-2 text-right border-b border-gray-200">
                ...
                {data.tax > 0 && (
                  <tr>
                    <td className="py-2 border-b border-gray-200">Tax (MYR):</td>
                    <td className="py-2 text-right border-b border-gray-200">
                      {data.tax.toFixed(2)}
                    </td>
                  </tr>
                ...
                {data.shipping > 0 && (
                  <tr>
                    <td className="py-2 border-b border-gray-200">Shipping (MYR):</td>
                    <td className="py-2 text-right border-b border-gray-200">
